...
const translations = {
  es: {
    ...
    'opt-general-desc': 'Las noticias más importantes de IA: avances, herramientas, regulación y tendencias que impactan tu industria.',
    'opt-general-tag': '100% Gratis',
    'opt-personal-title': 'Newsletter Personalizado + Guías',
    'opt-personal-desc': 'Insights de IA enfocados en tu negocio con acciones diarias aplicables. Sin tarjeta, sin compromisos. Prueba 7 días y si te agrega valor, renuevas.',
    'opt-personal-tag': 'Gratis 7 días',
  ...
  en: {
    ...
    'opt-general-desc': 'The most important AI news: breakthroughs, tools, regulation and trends impacting your industry.',
    'opt-general-tag': '100% Free',
    'opt-personal-title': 'Personalized Newsletter + Guides',
    'opt-personal-desc': 'AI insights focused on your business with actionable daily steps. No card, no strings attached. Try 7 days and renew if it adds value.',
    'opt-personal-tag': 'Free 7 days',
